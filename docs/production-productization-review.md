...
Status: reviewed on 2026-07-30. A01-A08 are complete and Gate G1 passed for the
synthetic hackathon sample; B01 is next. Gate G0/G1 must be repeated before
company use.
