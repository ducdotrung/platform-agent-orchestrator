...
| Resolve implementation architecture decisions | Approved runtime, delivery, persistence, identity, scope, deployment, and adapter ADRs | Repository Maintainer | G0 | A03-A06 accepted; next A07 |
