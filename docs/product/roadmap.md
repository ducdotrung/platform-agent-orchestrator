...
| Resolve implementation architecture decisions | Approved runtime, delivery, persistence, identity, scope, deployment, and adapter ADRs | Repository Maintainer | G0 | A03-A04 accepted; next A05-A07 |
